...
export const BuyIcon: FC<SvgIconProps> = ({wrapperClassName = "", className = ""}) => {
  return (
    <div className={wrapperClassName}>
      <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 -0.5 19 22" shapeRendering="crispEdges">
...
export const ProfileIcon: FC<SvgIconProps> = ({wrapperClassName = "", className = ""}) => {
  return (
    <div className={wrapperClassName}>
      <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 -0.5 16 16" shapeRendering="crispEdges">
...
export const ProfileOpenIcon: FC<SvgIconProps> = ({wrapperClassName = "", className = ""}) => {
  return (
    <div className={wrapperClassName}>
      <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 16 16" shapeRendering="crispEdges">        
